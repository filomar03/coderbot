...
#define MAX_VELOCITY 0.5 // m/s. approssimazione ricavata contanto i giri di ruota in 5 secondi con pwm al massimo
#define MAX_TICK_FREQ (MAX_VELOCITY / WHEEL_CIRCUMFERENCE * TICKS_PER_REV) // 1/s
#define MAX_TICK_DURATION (1 / MAX_TICK_FREQ) // s
